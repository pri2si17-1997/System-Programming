/*This is adder.c. Processor for subtraction.*/

#include "HEADER.h"

int main(int argc, char* argv[])
{
	int read_FD;//read file descriptor for pipe between server and processor.(subtractor)
	int write_FD;//wite file descriptor for pipe between server and processor.(subtractor)
