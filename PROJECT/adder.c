/*This is adder.c. Processor for addition.*/

#include "HEADER.h"

int main(int argc, char* argv[])
{
	int read_FD;//read file descriptor for pipe between server and processor.(adder)
	int write_FD;//wite file descriptor for pipe between server and processor.(adder)
